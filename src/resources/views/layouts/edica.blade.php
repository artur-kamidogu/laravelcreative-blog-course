...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets-edica/vendors/flag-icon-css/css/flag-icon.min.css')}} ">
    <link rel="stylesheet" href="{{asset('assets-edica/vendors/font-awesome/css/all.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets-edica/vendors/aos/aos.css')}}">
    <link rel="stylesheet" href="{{asset('assets-edica/css/style.css')}}">
    <script src="{{asset('assets-edica/vendors/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('assets-edica/js/loader.js')}}"></script>
</head>
<body>
...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html"><img src="{{asset('assets-edica/images/logo.svg')}}" alt="Edica"></a>
    ...
    <div class="container">
        <div class="footer-banner" data-aos="fade-up">
            ...
            <div class="banner-btns-wrapper">
                <button class="btn btn-success"> <img src="{{asset('assets-edica/images/apple@1x.svg')}}" alt="ios" class="mr-2"> App Store</button>
                <button class="btn btn-success"> <img src="{{asset('assets-edica/images/android@1x.svg')}}" alt="android" class="mr-2"> Google Play</button>
            </div>
        ...
        <div class="row footer-widget-area">
            <div class="col-md-3">
                <a href="index.html" class="footer-brand-wrapper">
                    <img src="{{asset('assets-edica/images/logo.svg')}}" alt="edica logo">
                </a>
...
<script src="{{asset('assets-edica/vendors/popper.js/popper.min.js')}}"></script>
<script src="{{asset('assets-edica/vendors/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets-edica/vendors/aos/aos.js')}}"></script>
<script src="{{asset('assets-edica/js/main.js')}}"></script>
<script>
    AOS.init({
        duration: 1000
    });
